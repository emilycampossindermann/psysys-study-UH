...
factors = ["Ängstlichkeit", "Sozialer Rückzug", "Pessimismus", "Energieverlust",
           "Verzweiflung / Hoffnungslosigkeit", "Beeinträchtigung im Alltag", "Gefühl der Wertlosigkeit",
           "Verminderter Appetit", "Einsamkeit", "Reizbarkeit", "Weinen", "Konzentrationsprobleme",
           "Probleme beim Einschlafen", "Gedanken an den Tod oder Suizid", "Selbstablehnung", "Erschöpfung",
           "Probleme durchzuschlafen", "Zu frühes Aufwachen", "Verlust an Interesse", "Traurige Stimmung",
           "Freudlosigkeit"]
...
factor_translation_map = {
    ...
    "Social withdrawal": "Sozialer Rückzug",
    "Pessimism": "Pessimismus",
    "Loss of energy": "Energieverlust",
    "Despair / Hopelessness": "Verzweiflung / Hoffnungslosigkeit",
    "Impairment in daily life": "Beeinträchtigung im Alltag",
    "Feeling of worthlessness": "Gefühl der Wertlosigkeit",
    "Decreased appetite": "Verminderter Appetit",
    "Loneliness": "Einsamkeit",
    "Irritability": "Reizbarkeit",
    "Crying": "Weinen",
    "Concentration problems": "Konzentrationsprobleme",
    "Difficulty falling asleep": "Probleme beim Einschlafen",
    "Thoughts of death or suicide": "Gedanken an den Tod oder Suizid",
    "Self-rejection": "Selbstablehnung",
    "Exhaustion": "Erschöpfung",
    "Difficulty staying asleep": "Probleme durchzuschlafen",
    "Early awakening": "Zu frühes Aufwachen",
    "Loss of interest": "Verlust an Interesse",
    "Sad mood": "Traurige Stimmung",
    "Anhedonia": "Freudlosigkeit"
}

# Dictionary
translations = {
    'en': {
        'factors': ["Anxiety", "Social withdrawal", "Pessimism", "Loss of energy",
                    "Despair / Hopelessness", "Impairment in daily life", "Feeling of worthlessness",
                    "Decreased appetite", "Loneliness", "Irritability", "Crying", "Concentration problems",
                    "Difficulty falling asleep", "Thoughts of death or suicide", "Self-rejection", "Exhaustion",
                    "Difficulty staying asleep", "Early awakening", "Loss of interest", "Sad mood", "Anhedonia"],
        ...
        'video_link_intro': "https://www.youtube.com/embed/-xp54xI-1PE?si=30BUKSN2ZEP6Q9_s&rel=0&modestbranding=1&enablejsapi=1",
        ...
        'video_link_block_01': "https://www.youtube.com/embed/mb91ZnrT9Bg?si=PJa94P0IMJJw4iNV&rel=0&modestbranding=1&enablejsapi=1",
        'placeholder_dd_01': "Select between 3 and 7 factors",
        'video_link_block_02': "https://www.youtube.com/embed/e-ppym1WsNA?si=Pck80FZK1WDIzDS4&rel=0&modestbranding=1&enablejsapi=1",
        'placeholder_dd_02': "Select at least 2 factors",
        ...
        'video_link_block_03': "https://www.youtube.com/embed/53t5ScSfpH0?si=Gof066JxVvdHV9eu&rel=0&modestbranding=1&enablejsapi=1",
        'placeholder_dd_03': "Select at least 1 factor",
        ...
        'video_link_block_04': "https://www.youtube.com/embed/Hbhe6kliuSI?si=Bb2P-q7bz8EcOwvd&rel=0&modestbranding=1&enablejsapi=1",
        'video_confirm': "I've watched the video ✓",
        ...
        'donation_title': "Submit Your Map",
        'donation_info': ("Here you can anonymously submit your map to our research team. By submitting, you agree that your anonymized data may be used for research purposes."),
        'donation_button': "Yes, submit my map",
        'submit_success_title': "Map submitted ✓",
        'submit_success_body': "Your map was successfully submitted to our research team. Please now return to the study to complete your participation.",
        'submit_success_link': "https://sosci.zdv.uni-mainz.de/PECAN_INT/?q=qnr4",
        'submit_back_to_study': "→ Return to Study",
        'submit_error_title': "Submission failed",
        'submit_error_body': "Something went wrong while submitting your map.",
        'submit_error_continue': "You can still return to the study:",
        'submit_close': "Close",
        'submit_error_detail': "Error code: ",
        'editor_locked_tooltip': "Complete PsySys first to access the Map Editor.",
        # Welcome pop-up (shown once per session before psychoeducation starts)
        'welcome_modal_title': "Welcome to PsySys 👋",
        'welcome_modal_intro': "PsySys guides you through three steps:",
        'welcome_modal_step1_title': "1 · Psychoeducation",
        'welcome_modal_step1_body': "Watch all 5 short videos and complete the exercises to build your personal mental health map.",
        'welcome_modal_step2_title': "2 · Map Editor",
        'welcome_modal_step2_body': "Extend your map — add or remove factors and connections until it feels right.",
        'welcome_modal_step3_title': "3 · Download & Submit",
        'welcome_modal_step3_body': "Download your map as a file (.json) and image (.jpg), then submit it to the research team.",
        'welcome_modal_btn': "Let's go!",
        # Map editor pop-up (shown every time editor is opened)
        'editor_modal_title': "Map Editor 🗺️",
        'editor_modal_intro': "",
        'editor_modal_step1_title': "✏️  Extend Your Map",
        'editor_modal_step1_body': "If needed, add missing factors or connections to your current map. You can also click on factors and connections to adjust their severity.",
        'editor_modal_step2_title': "📥  Download Your Map",
        'editor_modal_step2_body': "Download your map as a .json and .jpg file using the corresponding buttons.",
        'editor_modal_step3_title': "📤  Submit Your Map",
        'editor_modal_step3_body': "Click 'Submit' to send your map to our research team, then return to the study.",
        'editor_modal_btn': "Got it!",
        'congrats_title': "Congratulations! 🎉",
        'congrats_body': "You've completed PsySys! Have a look at your map and then click the glowing button below the map to open the Map Editor.",
        'congrats_editor_btn': "Open Map Editor",
        ...
        'hover-donate': "Submit map to study",
        ...
        "demo_title": "Welcome to PsySys",
        "demo_step1": "📚  Click Start and work through the PsySys steps to create your Mental-Health-Map.",
        "demo_step2": "✏️  Then go to the Map Editor to extend your map.",
        "demo_step3": "📤  Download your map as a .json and .jpg file and submit it to return to the study.",
        "target_factor_title": "🎯 Your Selected Focus",
        "edit-text": "Extend your Mental-Health-Map. Add any missing factors or connections. Save it as a file and image. Then click the Submit button below to send your map to our research team.",
        ...
        'factor_descriptions': {
            "Anxiety": "A persistent feeling of nervousness or fear, often without a clear cause.",
            "Social withdrawal": "Pulling back from social interactions and relationships, often due to discomfort, fatigue, or loss of interest.",
            "Pessimism": "A tendency to expect negative outcomes or to focus on difficulties rather than possibilities.",
            "Loss of energy": "Persistent lack of physical or mental energy, making everyday tasks feel exhausting.",
            "Despair / Hopelessness": "A pervasive sense that improvement or a positive future is unattainable.",
            "Impairment in daily life": "Difficulties managing everyday responsibilities like work, household tasks, or self-care.",
            "Feeling of worthlessness": "Believing oneself to be fundamentally inadequate or of little value.",
            "Decreased appetite": "A notable reduction in hunger or interest in eating.",
            "Loneliness": "A painful feeling of being disconnected or not belonging, even when surrounded by others.",
            "Irritability": "A heightened sensitivity to frustration, often leading to anger or annoyance over minor issues.",
            "Crying": "Frequent or uncontrollable episodes of crying, sometimes without a clear reason.",
            "Concentration problems": "Difficulty focusing, staying attentive, or processing information effectively.",
            "Difficulty falling asleep": "Trouble initiating sleep at bedtime, often due to racing thoughts or physical tension.",
            "Thoughts of death or suicide": "Thoughts or urges related to ending one's life, often stemming from overwhelming emotional pain.",
            "Self-rejection": "A critical inner attitude towards oneself, often involving feelings of shame or not being good enough.",
            "Exhaustion": "Persistent physical or mental fatigue that is not relieved by rest.",
            "Difficulty staying asleep": "Waking frequently during the night and struggling to fall back asleep.",
            "Early awakening": "Waking up much earlier than intended and being unable to return to sleep.",
            "Loss of interest": "A decline in enthusiasm or pleasure from activities that were once enjoyable.",
            "Sad mood": "Deep feelings of melancholy or despair that persist and impact daily life.",
            "Anhedonia": "The inability to feel pleasure from activities or experiences that were previously enjoyable.",
        }
    },
    'de': {
        'factors': ["Ängstlichkeit", "Sozialer Rückzug", "Pessimismus", "Energieverlust",
        ...
        'suicide-prevention': html.P(["Wenn Du ", 
                                      ...
                                      html.A("diesen Link", href="https://findahelpline.com", target="_blank", 
                                             ...
                                             " besuchst."]),
        'video_link_intro': "https://www.youtube.com/embed/iAD3SAvDc2s?si=ZE9nz2ghhzqtwuTZ&rel=0&modestbranding=1&enablejsapi=1",
        ...
        'video_link_block_01': "https://www.youtube.com/embed/VbtrHB-R8aQ?si=SLZj1ykaXey-shvZ&rel=0&modestbranding=1&enablejsapi=1",
        'placeholder_dd_01': "Wähle zwischen 3 und 7 Faktoren aus",
        'video_link_block_02': "https://www.youtube.com/embed/p3iVzuhIhrk?si=0YsKJkr-HgVDVJkN&rel=0&modestbranding=1&enablejsapi=1",
        'placeholder_dd_02': "Wähle mindestens 2 Faktoren aus",
        ...
        'video_link_block_03': "https://www.youtube.com/embed/98JNUCJrbbA?si=Eci1YF2-pd4iZDZx&rel=0&modestbranding=1&enablejsapi=1",
        'placeholder_dd_03': "Wähle mindestens 1 Faktor aus",
        ...
        'video_link_block_04': "https://www.youtube.com/embed/gUMGu49w7o0?si=sUabGZ5BheGLgA_F&rel=0&modestbranding=1&enablejsapi=1",
        'video_confirm': "Ich habe das Video angeschaut ✓",
        ...
        'donation_title': "Map einreichen",
        'donation_info': ("Hier kannst Du Deine Mental-Health-Map anonym an unser Forschungsteam übermitteln. Mit dem Einreichen stimmst Du zu, dass Deine anonymisierten Daten für Forschungszwecke verwendet werden dürfen."),
        'donation_button': "Ja, Map einreichen",
        'submit_success_title': "Map eingereicht ✓",
        'submit_success_body': "Deine Map wurde erfolgreich an unser Forschungsteam übermittelt. Gehe jetzt zurück zur Studie, um Deine Teilnahme abzuschließen.",
        'submit_success_link': "https://sosci.zdv.uni-mainz.de/PECAN_INT/?q=qnr4",
        'submit_back_to_study': "→ Zurück zur Studie",
        'submit_error_title': "Fehler beim Einreichen",
        'submit_error_body': "Beim Einreichen Deiner Map ist ein Fehler aufgetreten.",
        'submit_error_continue': "Du kannst trotzdem zur Studie zurückkehren:",
        'submit_close': "Schließen",
        'submit_error_detail': "Fehlercode: ",
        'editor_locked_tooltip': "Schließe zuerst die Psychoedukation ab, um den Editor zu öffnen.",
        # Welcome pop-up (shown once per session before psychoeducation starts)
        'welcome_modal_title': "Willkommen bei PsySys 👋",
        'welcome_modal_intro': "PsySys führt Dich durch drei Schritte:",
        'welcome_modal_step1_title': "1 · Psychoedukation",
        'welcome_modal_step1_body': "Schaue Dir alle 5 kurzen Videos an und bearbeite die Übungen, um Deine persönliche Mental-Health-Map zu erstellen.",
        'welcome_modal_step2_title': "2 · Map Editor",
        'welcome_modal_step2_body': "Passe Deine Map weiter an — füge Faktoren und Verbindungen hinzu oder entferne sie.",
        'welcome_modal_step3_title': "3 · Download & Einreichen",
        'welcome_modal_step3_body': "Lade Deine Map als Datei (.json) und Bild (.jpg) herunter und reiche sie dem Forschungsteam ein.",
        'welcome_modal_btn': "Los geht's!",
        # Map editor pop-up (shown every time editor is opened)
        'editor_modal_title': "Map Editor 🗺️",
        'editor_modal_intro': "",
        'editor_modal_step1_title': "✏️  Erweitere Deine Map",
        'editor_modal_step1_body': "Falls nötig, füge neue Faktoren oder Verbindungen hinzu, die Dir in Deiner jetzigen Map fehlen. Du kannst auch auf Faktoren und Verbindungen klicken, um ihren Schweregrad anzupassen.",
        'editor_modal_step2_title': "📥  Lade Deine Map herunter",
        'editor_modal_step2_body': "Bitte lade Deine Map als .json und .jpg Datei herunter, indem Du auf die entsprechenden Buttons klickst.",
        'editor_modal_step3_title': "📤  Reiche Deine Map ein",
        'editor_modal_step3_body': "Klicke auf 'Submit' um Deine Map einzureichen, dann gehe zurück zur Studie:",
        'editor_modal_btn': "Verstanden!",
        'congrats_title': "Glückwunsch! 🎉",
        'congrats_body': "Du hast PsySys abgeschlossen! Wirf einen Blick auf Deine Map und klicke dann auf den leuchtenden Button unter der Map, um den Map Editor zu öffnen.",
        'congrats_editor_btn': "Map Editor öffnen",
        'congrats_close': "Schließen",
        ...
        'hover-donate': "Map an Studie einreichen",
        ...
        "demo": "",
        "demo_title": "Willkommen bei PsySys",
        "demo_step1": "📚  Klicke auf Start und bearbeite die PsySys Schritte, um Deine Mental-Health-Map zu erstellen.",
        "demo_step2": "✏️  Gehe anschließend auf den Map Editor, um Deine Map zu erweitern.",
        "demo_step3": "📤  Lade Deine Map als .json und .jpg Datei herunter und reiche sie ein, um zurück zur Studie zu gelangen.",
        ...
        "target_factor_title": "🎯 Dein Ausgewählter Schwerpunkt",
        "edit-text": "Erweitere Deine Mental-Health-Map. Füge fehlende Faktoren oder Verbindungen hinzu. Speichere sie als Datei und Bild ab. Klicke dann auf den Submit-Button unten, um Deine Map einzureichen.",
        ...
        'factor_descriptions': {
            "Ängstlichkeit": "Ein anhaltendes Gefühl von Nervosität oder Angst, oft ohne klaren Grund.",
            "Sozialer Rückzug": "Rückzug aus sozialen Kontakten und Beziehungen, oft durch Unbehagen, Erschöpfung oder Interessenverlust.",
            "Pessimismus": "Die Tendenz, negative Ausgänge zu erwarten oder sich auf Schwierigkeiten statt Möglichkeiten zu fokussieren.",
            "Energieverlust": "Anhaltender Mangel an körperlicher oder geistiger Energie, sodass alltägliche Aufgaben erschöpfend wirken.",
            "Verzweiflung / Hoffnungslosigkeit": "Das Gefühl, dass sich die Umstände nicht verbessern können oder die Zukunft aussichtslos ist.",
            "Beeinträchtigung im Alltag": "Schwierigkeiten, alltägliche Aufgaben wie Arbeit, Haushalt oder Selbstfürsorge zu bewältigen.",
            "Gefühl der Wertlosigkeit": "Die Überzeugung, grundlegend unzulänglich oder wertlos zu sein.",
            "Verminderter Appetit": "Eine merkliche Abnahme des Hungers oder des Interesses an Essen.",
            "Einsamkeit": "Ein schmerzhaftes Gefühl der Getrenntheit oder des Nicht-Dazugehörens, auch wenn man von anderen umgeben ist.",
            "Reizbarkeit": "Eine erhöhte Empfindlichkeit gegenüber Frustration, die oft zu Wut oder Ärger führt.",
            "Weinen": "Häufige oder unkontrollierte Weinausbrüche, manchmal ohne erkennbaren Grund.",
            "Konzentrationsprobleme": "Schwierigkeiten, sich zu fokussieren, aufmerksam zu bleiben oder Informationen zu verarbeiten.",
            "Probleme beim Einschlafen": "Schwierigkeiten, nachts einzuschlafen, oft durch Gedankenkreisen oder körperliche Anspannung.",
            "Gedanken an den Tod oder Suizid": "Gedanken oder Impulse, das eigene Leben zu beenden, oft verursacht durch überwältigenden emotionalen Schmerz.",
            "Selbstablehnung": "Eine kritische innere Haltung sich selbst gegenüber, oft verbunden mit Scham oder dem Gefühl, nicht gut genug zu sein.",
            "Erschöpfung": "Anhaltende körperliche oder geistige Müdigkeit, die durch Ruhe nicht gelindert wird.",
            "Probleme durchzuschlafen": "Häufiges Aufwachen in der Nacht und Schwierigkeiten, wieder einzuschlafen.",
            "Zu frühes Aufwachen": "Früher als beabsichtigt aufwachen und nicht mehr einschlafen können.",
            "Verlust an Interesse": "Weniger Freude oder Interesse an Aktivitäten, die früher Spaß gemacht haben.",
            "Traurige Stimmung": "Tiefe Gefühle von Melancholie oder Verzweiflung, die den Alltag beeinträchtigen.",
            "Freudlosigkeit": "Die Unfähigkeit, Freude an Aktivitäten oder Erlebnissen zu empfinden, die früher Genuss bereitet haben.",
        }
    }
}
...
HEADER_STYLE = {
    ...
    "paddingLeft": "150px",
    # Must NOT intercept mouse events — the nav bar sits behind this overlay
    # at the same z-index, so without this the nav links are completely blocked.
    "pointerEvents": "none",
}
