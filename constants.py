...
translations = {
    'en': {
        ...
        'submit_success_body': "Your map was successfully submitted to our research team. Please now go to the study link to complete your participation.",
        'submit_success_link': "https://sosci.zdv.uni-mainz.de/PECAN_INT/?q=qnr4",
        'submit_error_title': "Submission failed",
        'submit_error_body': "Something went wrong while submitting your map. Please try again or contact the study team.",
        'submit_close': "Close",
        ...
        "edit-text": "Extend your Mental-Health-Map. Add any missing factors or connections. Save it as a file and image. Then submit it and return to the study:",
    ...
    'de': {
        ...
        'submit_success_link': "https://sosci.zdv.uni-mainz.de/PECAN_INT/?q=qnr4",
        'submit_error_title': "Einreichung fehlgeschlagen",
        'submit_error_body': "Beim Einreichen Deiner Map ist ein Fehler aufgetreten. Bitte versuche es erneut oder kontaktiere das Studienteam.",
        ...
        "edit-text": "Erweitere Deine Mental-Health-Map. Füge fehlende Faktoren oder Verbindungen hinzu. Speichere sie als Datei und Bild ab. Reiche sie anschließend ein und kehre zur Studie zurück:",
